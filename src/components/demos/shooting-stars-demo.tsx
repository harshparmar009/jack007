...
const features = [
  ...
  },
  {
    ...
    title: "Advance SEO",
    description:
      "We offer Advance SEO support for all our clients. Call us for more information.",
  },
  {
...
export function ShootingStarsAndStarsBackgroundDemo() {
  return (
    <div className="mt-20 py-10 md:py-20 rounded-[40px] bg-neutral-900 flex flex-col items-center justify-center relative w-full px-6 md:px-0">
      ...
      {/* Features */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10 z-10 xl:w-4/5 2xl:w-[68%] mx-auto ">
